...
def test_status(capsys, mock_format_time):
    ...
    assert captured.out == "2021-07-01 12:00:00 [-] [Ident] [STATUS] 200 OK (build)\n    item: a\n"
...
def test_warning(capsys, mock_format_time):
    ...
    captured = capsys.readouterr()
    assert captured.out == "2021-07-01 12:00:00 [-] [Ident] [WARN] Waiting for 2 running action to complete\n    item: a\n"
...
def test_trace(capsys, mock_format_time):
    ...
    captured = capsys.readouterr()
    assert captured.out == "2021-07-01 12:00:00 [-] [prn:core:network:master:1] [TRACE] This a trace message\n"
...
def test_level_change(capsys, mock_format_time):
    ...
    captured = capsys.readouterr()
    assert captured.out == "2021-07-01 12:00:00 [-] [my_test] [INFO] This is my test log message\n    key: value\n"
    ...
    captured = capsys.readouterr()
    assert captured.out == "2021-07-01 12:00:00 [-] [my_test] [DEBUG] The second round of log messages\n    key: value\n"
